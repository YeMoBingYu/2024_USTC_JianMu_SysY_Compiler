...
public:
  ...
  bool is_fge() const { return op_id_ == fge; }
  bool is_gt() const { return op_id_ == gt; }
  bool is_fgt() const { return op_id_ == fgt; }
  bool is_le() const { return op_id_ == le; }
  bool is_fle() const { return op_id_ == fle; }
  bool is_lt() const { return op_id_ == lt; }
  bool is_flt() const { return op_id_ == flt; }
  bool is_eq() const { return op_id_ == eq; }
  bool is_feq() const { return op_id_ == feq; }
  bool is_ne() const { return op_id_ == ne; }
  bool is_fne() const { return op_id_ == fne; }
  ...
  bool isBinary() const
  {
    return (is_add() || is_sub() || is_mul() || is_div() || is_fadd() ||
            is_fsub() || is_fmul() || is_fdiv() || is_srem()) &&
           (get_num_operand() == 2);
  }

  bool isTerminator() const { return is_br() || is_ret(); }

  unsigned begin_num_ = 0;
  unsigned end_num_ = 0;
  unsigned max_num_;
  unsigned min_num_;
  unsigned line_num_;
  bool name_num_=false;
